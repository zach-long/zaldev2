...
export default function Contact() {
    return (
        <section id="contact" className="flex flex-col lg:flex-row flex-nowrap lg:min-h-[24rem] bg-zinc-700 dark:bg-blue-600">
            <div className="lg:w-2/12 pt-12 lg:pt-0 relative text-darkpizazz">
                <h2 className="lg:text-8xl lg:-rotate-90 lg:-translate-y-2/4 lg:-translate-x-2/4 lg:top-2/4 lg:left-2/4 lg:absolute text-center text-4xl">Contact</h2>
            ...
            <div className="lg:w-10/12 pt-12 pb-32 text-white flex flex-col flex-nowrap justify-center items-center">
                <div className="pb-4 px-16 pt-10 text-center">This website is an ongoing project, until I set up email on the backend, please send me a message yourself!</div>
