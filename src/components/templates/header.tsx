    ...
    return (
        <header id="top" className="h-screen relative bg-zinc-100 overflow-hidden overscroll-contain">
            ...
            <div className="text-center absolute top-1/3 left-2/4 -translate-x-2/4 -translate-y-2/4">
                <h1 className="text-4xl lg:text-6xl opacity-0 animate-fade-in-name">Zachary Long</h1>
                <h5 className="text-xl lg:text-2xl mt-8 opacity-0 animate-fade-in-title">Full Stack Developer</h5>
            </div>
